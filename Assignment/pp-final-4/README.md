# Principles of Programming Final - Problem 4 (30 points)

## Objective

Implement the functions in `src/sudoku.rs` with appropriate Rust code.
...
Run the following command to compile and execute the tests in `src/sudoku.rs`:
```bash
cargo test
```
...
- Only the provided `src/sudoku.rs` file will be used for testing. **Any additional files you create will not be included.**
